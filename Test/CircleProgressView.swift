...
//            // circular cap
//            let r:CGFloat = (diameter - trackWidth) / 2
//            let startPos:CGPoint = CGPointMake(center.x, center.y - r)
//            let end:CGFloat = CGFloat(progress * M_PI / 180)
//            let endPos:CGPoint = CGPointMake(center.x + r * cos(end), center.y - r * sin(end))
//            
//            let startCircularCap = UIBezierPath(ovalInRect: CGRectMake(startPos.x - trackWidth / 2, startPos.y - trackWidth / 2, trackWidth, trackWidth))
//            trackFillColor.setFill()
//            startCircularCap.fill()
//            let endCircularCap = UIBezierPath(ovalInRect: CGRectMake(endPos.x - trackWidth / 2, endPos.y - trackWidth / 2, trackWidth, trackWidth))
//            trackFillColor.setFill()
//            endCircularCap.fill()
        }
        ...
        let progressFont:UIFont = UIFont(name: diameter > 50 ? "Lato-Light" : "Lato-Regular", size: fontSize)!
        let percentageFont:UIFont = UIFont(name: "Lato-Regular", size: fontSize / 2)!
